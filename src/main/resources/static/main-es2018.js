...
TaskEditComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: TaskEditComponent, selectors: [["edit-task"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_services_task_api_service__WEBPACK_IMPORTED_MODULE_1__["TaskApiService"]])], decls: 26, vars: 7, consts: [[1, "row"], [1, "col-xs-12"], [1, "form-horizontal", 3, "formGroup", "ngSubmit"], ["type", "hidden", "formControlName", "id"], ["type", "hidden", "formControlName", "version"], [1, "form-group"], ["for", "title", 1, "col-xs-2"], [1, "col-xs-6"], ["id", "title", "placeholder", "Title", "formControlName", "title", 1, "form-control"], [3, "hidden"], ["for", "description", 1, "col-xs-2"], ["id", "description", "placeholder", "Description", "formControlName", "description", 1, "form-control"], ["type", "submit", "value", "Submit", 1, "btn", "btn-primary"], [3, "routerLink"]], template: function TaskEditComponent_Template(rf, ctx) { if (rf & 1) {
...
TaskCreateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({ type: TaskCreateComponent, selectors: [["create-task"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵProvidersFeature"]([_services_task_api_service__WEBPACK_IMPORTED_MODULE_0__["TaskApiService"]])], decls: 24, vars: 7, consts: [[1, "row"], [1, "col-xs-12"], [1, "form-horizontal", 3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "title", 1, "col-xs-2"], [1, "col-xs-6"], ["id", "title", "placeholder", "Title", "formControlName", "title", 1, "form-control"], [3, "hidden"], ["for", "description", 1, "col-xs-2"], ["id", "description", "placeholder", "Description", "formControlName", "description", 1, "form-control"], ["type", "submit", "value", "Submit", 1, "btn", "btn-primary"], [3, "routerLink"]], template: function TaskCreateComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](2, "form", 2);
